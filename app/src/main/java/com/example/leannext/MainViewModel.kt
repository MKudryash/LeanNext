...
class MainViewModel(val database: MainDb) : ViewModel() {
    ...
    private fun loadCriteriasDirection() {
        ...
        val listAnswerCriterias = mutableStateListOf(
            AnswerCriterias(1, 1, 5.0, Timestamp(System.currentTimeMillis())),
            AnswerCriterias(2, 2, 1.0, Timestamp(System.currentTimeMillis())),
            AnswerCriterias(3, 3, 2.0, Timestamp(System.currentTimeMillis())),
            AnswerCriterias(4, 1, 1.0, Timestamp(System.currentTimeMillis())),
            AnswerCriterias(5, 2, 3.0, Timestamp(System.currentTimeMillis())),
            AnswerCriterias(5, 2, 3.0, Timestamp(System.currentTimeMillis()))
        )
        viewModelScope.launch {
