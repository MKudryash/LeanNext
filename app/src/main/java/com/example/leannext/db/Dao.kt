...
interface Dao {
    ...
    /*Запросы для работы с таблицей AnswerCriterias*/
    ...
    /*Запросы для работы с таблицей Directions*/
